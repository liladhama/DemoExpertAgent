...
function extractOptions(message) {
  // 1) Поиск по "Варианты: ...", "Например: ...", "Может быть: ...", "Выбери: ..."
  const re = /^(Варианты|Например|Может быть|Выбери)[:：]?([\s\S]+?)(?:\n|$|Если твой вариант|Если ваш вариант|Если не подходит|Напиши свой|$)/im;
  ...
  // 2) Поиск фраз "... может быть ... или ..." или "... это может быть ... или ..."
  const re2 = /(?:\bможет быть\b|\bэто может быть\b)[^:]*?([а-яa-z0-9 ,]+?)(?:\?|\.|!|$)/i;
